...
public class HipHop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_hiphop);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(HipHop.this, GameLevels.class);
        ...
        dialogEnd.setContentView(R.layout.dialogendhiphop);
        ...
        //Анимация - начало
        final Animation a = AnimationUtils.loadAnimation(HipHop.this, R.anim.alpha);
        //Анимация - конец

        int numsound = random.nextInt(array.hiphopsounds.length);
        ...
        numRight = random.nextInt(array.hiphopsounds.length);
        while (numLeft == numRight) {
            numRight = random.nextInt(array.hiphopsounds.length);
        }

        if (randomSong != array.hiphopsounds[numLeft] && randomSong != array.hiphopsounds[numRight]) {
            randomSong = random.nextInt(array.hiphopsounds.length);
        }


        img_right.setImageResource(array.img_3[numRight]);
        ...
        img_test.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (array.hiphopsounds[numLeft] == randomSong) {
        ...
        img_right.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (array.hiphopsounds[numRight] == randomSong) {
        ...
        while ((numsound != numLeft) && (numsound != numRight)) {
            numsound = random.nextInt(array.hiphopsounds.length);
        }
        randomSong = array.hiphopsounds[numsound];
