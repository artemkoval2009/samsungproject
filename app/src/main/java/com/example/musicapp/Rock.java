...
public class Rock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_rock);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Rock.this, GameLevels.class);
        ...
        dialogEnd.setContentView(R.layout.dialogendrock);
        ...
        //Анимация - начало
        final Animation a = AnimationUtils.loadAnimation(Rock.this, R.anim.alpha);
        //Анимация - конец

        int numsound = random.nextInt(array.rocksounds.length);
        ...
        numRight = random.nextInt(array.rocksounds.length);
        while (numLeft == numRight) {
            numRight = random.nextInt(array.rocksounds.length);
        }

        if (randomSong != array.rocksounds[numLeft] && randomSong != array.rocksounds[numRight]) {
            randomSong = random.nextInt(array.rocksounds.length);
        }

        img_right.setImageResource(array.img_2[numRight]);
        ...
        img_test.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (array.rocksounds[numLeft] == randomSong) {
        ...
        img_right.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (array.rocksounds[numRight] == randomSong) {
        ...
        while ((numsound != numLeft) && (numsound != numRight)) {
            numsound = random.nextInt(array.rocksounds.length);
        }
        randomSong = array.rocksounds[numsound];
